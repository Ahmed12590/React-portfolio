    ...
    <>
      <section id="about" className="max-w-7xl mx-auto my-12 container text-left">
        <div className="relative max-w-4xl mx-auto">
          ...
          <p className="lg:text-3xl text-2xl text-gray-200 font-bold mb-6">Hello! my name is <span className="text-sky-400">Muhammad Ahmed</span>, a software engineer based in Karachi, Pakistan. </p>
          ...
          <p className="text-xl leading-9">I am studding <span className="text-sky-400">Computer Science</span> from <span className="text-sky-400">ILMA University</span>, I am also working with an engineering team at <span className="text-sky-400">Nirsh Productions.</span> as an Associate software engineer, where I am working on a wide variety of interesting and meaningful projects on a daily basis.</p>
